export const description =
  "Reference for Nitric's v0 JVM library - Register a single handler for all HTTP Methods (GET, POST, PUT, DELETE, PATCH) on the route."
...
public class Application {
  ...
  public static void main(String[] args) {
    ...
    api.route("/customer").all(List.of(Application::validateRequest, Application::handleRequest));
...
fun main() {
  ...
  api.route("/customer").all(listOf(validateRequest, handleRequest))
