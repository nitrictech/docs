...
func main() {
  profiles, err := nitric.NewBucket("profiles").With(nitric.BucketWriting, nitric.BucketReading, nitric.BucketDeleting)
  if err != nil {
    return
  }
...
func main() {
  profiles, err := nitric.NewBucket("profiles").With(nitric.BucketReading)
  if err != nil {
    return
  }
...
func main() {
  profiles, err := nitric.NewBucket("profiles").With(nitric.BucketDeleting)
  if err != nil {
    return
  }
...
func main() {
  profiles, err := nitric.NewBucket("profiles").With(nitric.BucketReading, nitric.BucketWriting)
  if err != nil {
    return
  }
