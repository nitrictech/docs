export const description = 'How Nitric deploys Collections to Azure'

# Azure Resources - Collections
...
During deployment the Nitric CLI builds your Collections as follows:
