...
<Note>
  ...
  [installation guide](/guides/getting-started/v0/installation).
</Note>
...
nitric new hello-world "official/JavaScript - Starter"
```

```bash {{ title: "Python" }}
nitric new hello-world "official/Python - Starter"
```

```bash {{ title: "Go" }}
nitric new hello-world "official/Go - Starter (experimental)"
```

```bash {{ title: "C#" }}
nitric new hello-world "official/C# - Starter (experimental)"
```
...
Once the API is registered, you can test the API using any HTTP client, your browser, or the [local dashboard](/guides/getting-started/v0/local-dashboard):
...
Continue by picking a region for your stack.
...
- Learn more about the [concepts](/guides/getting-started/v0/concepts) of Nitric
