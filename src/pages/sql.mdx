...
<Note>
  ...
  service you choose. [AWS RDS Pricing](https://aws.amazon.com/rds/pricing/), [Google Cloud SQL Pricing](https://cloud.google.com/sql/pricing), and [Azure Database for PostgreSQL Pricing](https://azure.microsoft.com/en-us/pricing/details/postgresql/flexible-server/).
</Note>
