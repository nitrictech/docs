export const description = 'Frequently asked questions about Nitric.'
...
Nitric's API is built on gRPC. We provide SDKs for Node.js, Python, Go and C# but gRPC also provides support and code generation for many other languages.
