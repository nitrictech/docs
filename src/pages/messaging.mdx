...
func main() {
	userCreatedTopic, _ := nitric.NewTopic("user-created").Allow(nitric.TopicPublish)
...
func main() {
	...
	userCreatedTopic.Subscribe(func(ctx *handler.MessageContext, next handler.MessageHandler) (*handler.MessageContext, error) {
...
func main() {
	transactionQueue, _ := nitric.NewQueue("transactions").Allow(nitric.QueueEnqueue, nitric.QueueDequeue)
...
func main() {
	transactionQueue, _ := nitric.NewQueue("transactions").Allow(nitric.QueueEnqueue)
...
func main() {
	transactionQueue, _ := nitric.NewQueue("transactions").Allow(nitric.QueueDequeue)
