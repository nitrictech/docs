...
func main() {
  loopTopic, err := resources.NewTopic("updates").With(resources.TopicPublishing)
  if err != nil {
    return
  }
...
func main() {
	transactionQueue, err := resources.NewQueue("transactions").With(resources.QueueSending, resources.QueueReceiving)
  if err != nil {
    fmt.Prinln(err)
    return
  }
...
func main() {
	transactionQueue, err := resources.NewQueue("transactions").With(resources.QueueSending)
  if err != nil {
    fmt.Prinln(err)
    return
  }
...
func main() {
	transactionQueue, err := resources.NewQueue("queue-name").With(resources.QueueReceiving)
	if err != nil {
		return
	}
