...
const userCreatedTopic = topic('user-created').for('publish')
```
...
const loopTopic = topic('infinite').for('publish')
...
const transactionQueue = queue('transactions').for('enqueue', 'dequeue')
```
...
const transactionQueue = queue('transactions').for('enqueue')
...
const transactionQueue = queue('transactions').for('dequeue')
