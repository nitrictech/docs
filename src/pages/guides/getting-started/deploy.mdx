...
![Nitric Deploy sign-in screen](/images/guides/deploy/sign-in.png)
...
![Creating an organization in Nitric Deploy](/images/guides/deploy/add-org.png)
...
![Adding AWS credentials in Nitric Deploy](/images/guides/deploy/add-connection.png)
...
![Import a Git repo or clone a template in Nitric Deploy](/images/guides/deploy/add-project.png)
...
![Configure a Nitric project from a GitHub repo](/images/guides/deploy/add-project-existing.png)
...
![Creating a new Nitric project](/images/guides/deploy/add-project-new.png)
...
![A project in Nitric Deploy with no environments created](/images/guides/deploy/new-environment.png)

![Create a stack environment for your project](/images/guides/deploy/new-environment-2.png)
...
![Add environment variables for production and staging](/images/guides/deploy/new-environment-variable.png)
...
![A stack deployed with Nitric Deploy infrastructure automation](/images/guides/deploy/deployed-stack.png)

## View the logs

By clicking on 'view latest build' we can see the details and retrieve the deployment log information.

![Cloud deployment logs in Nitric Deploy](/images/guides/deploy/deploy-logs.png)
...
- Get started on one of our [guides](/guides/serverless-rest-api-example) to build a new project with the Nitric CLI
