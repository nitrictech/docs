...
| Redis      | [Amazon ElastiCache for Redis](https://aws.amazon.com/elasticache/redis/)   | [Memorystore for Redis](https://cloud.google.com/memorystore/redis)                  | [Azure Cache for Redis](https://azure.microsoft.com/en-us/products/cache/)              |
