export const description =
  'Learn how to develop an event-driven uptime monitoring tool using Node.js and Nitric.'
...
**In a hurry?** You can view and download the finished application [here](https://github.com/nitrictech/example-apps/tree/main/uptime-monitoring).
...
As a next step, [deploy](/guides/getting-started/deployment) your app to the cloud of your choice.
