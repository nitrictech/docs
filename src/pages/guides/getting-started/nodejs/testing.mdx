...
```javascript {{ label: "resources/apis.js" }}
import { api } from '@nitric/sdk'

export const helloApi = api('main')
```

```javascript {{ label: "resources/buckets.js" }}
...
```javascript {{ label: "handlers/hello.js" }}
...
```javascript {{ label: "services/hello.js" }}
...
```javascript {{ label: "test/example.test.js" }}
...
```javascript {{ label: "functions/hello.js" }}
import { imageBucket } from '../resources/buckets'
import { helloApi } from '../resources/apis'
...
```javascript {{ label: "tests/integration.test.js" }}
