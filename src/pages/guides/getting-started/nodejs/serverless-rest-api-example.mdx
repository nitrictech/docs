...
There is also an extended section of the guide that adds file operations using a Nitric [bucket](/buckets) to store and retrieve profile pictures. The extension adds these routes to the API:
