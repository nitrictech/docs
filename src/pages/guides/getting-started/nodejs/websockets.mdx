export const description = 'Getting started building realtime applications on Nitric'
...
<Note>
  This guide relies on the Websocket feature of Nitric which is currently in preview.
  See the docs for this feature to [see how to enable it](/websockets).
</Note>
...
If you connect multiple clients using your preferred client and send messages each client should recieve messages from other clients:
...
<Note>
  Nitric only supports AWS for websockets at this time
</Note>
