export const description =
  'Add functions, queues, events or secrets to Supabase apps using the Nitric framework'
...
![New table steps diagram](/images/guides/nitric-and-supabase/supabase_createnewtable.png)
...
![create profiles table steps diagram](/images/guides/nitric-and-supabase/supabase_createprofilestable.png)
...
![SendGrid create new sender dialog screenshot](/images/guides/nitric-and-supabase/sendgrid_newsenderdetails.png)
...
![create API key dialog screenshot](/images/guides/nitric-and-supabase/sendgrid_createapikey.png)
...
![example project structure](/images/guides/nitric-and-supabase/project_structure.png)
...
<Note>
  _Note:_ the `dev` script in the template starts the Nitric Server using
  `nitric start` and runs your functions.
</Note>
...
![create function hook screenshot](/images/guides/nitric-and-supabase/supabase_createfunctionhook.png)
...
![create function hook screenshot - step 1](/images/guides/nitric-and-supabase/supabase_createfunctionhook_step1.png)

For _Type of hook_ select _HTTP Request_:

![create function hook screenshot - step 2](/images/guides/nitric-and-supabase/supabase_createfunctionhook_step2.png)
...
![create function hook screenshot - step 3](/images/guides/nitric-and-supabase/supabase_createfunctionhook_step3.png)
...
![Supabase editor screenshot](/images/guides/nitric-and-supabase/supabase_insertrow.png)
