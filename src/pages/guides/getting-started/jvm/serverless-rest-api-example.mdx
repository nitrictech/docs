...
The scaffolded project should have a structure similar to below (it will differ depending on Java or Kotlin):
...
```java {{ tag: "src/main/java/Application.java", title: "Java" }}
...
```kotlin {{ tag: "src/main/kotlin/Application.kt", title: "Kotlin" }}
import io.nitric.Nitric
import io.nitric.resources.CollectionPermission
