...
```hcl {{ tag:'aws/deploytf/.nitric/modules/bucket/variables.tf' }}
...
Because the [Terraform providers](https://nitric.io/docs/reference/providers/terraform) are in preview, you'll also need to enable `beta-providers` in your Nitric project by adding the following to your project's nitric.yaml file:
