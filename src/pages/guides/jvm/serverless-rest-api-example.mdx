export const description =
  'Use the Nitric framework to easily build and deploy JVM REST APIs for AWS, Azure or GCP'

export const title_meta = 'Building your first API with JVM and Nitric'
