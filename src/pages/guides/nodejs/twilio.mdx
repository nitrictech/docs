...
```typescript {{ label: "common/messenger.ts" }}
...
```typescript {{ label: "services/text.ts" }}
...
Thats it! If you want to deploy the API you can use our [deployment](/guides/getting-started/quickstart#deploying-the-app) docs.
