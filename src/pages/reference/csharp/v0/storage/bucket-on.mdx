export const description = "Reference for Nitric's .NET library - Create a new bucket notification trigger"
...
<Properties>
  ...
  <Property name="notificationType" required type="BucketNotificationType.Write | BucketNotificationType.Delete">
  ...
  <Property name="middleware" required type="BucketNotificationMiddleware | BucketNotificationMiddleware[]">
