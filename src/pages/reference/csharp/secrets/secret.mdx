export const description =
  "Reference for Nitric's .NET library - Creates a reference to a secret in the secrets manager."
...
var keyRef = Nitric.Sdk.Nitric.Secret("apiKey").With(SecretPermission.Putting);
