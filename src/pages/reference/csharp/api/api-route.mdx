export const description =
  "Reference for Nitric's v0 .NET library - Creates a new route (path) within an API."
...
```csharp
var route = Nitric.Sdk.Nitric.Api("main").Route("/customers/:customerId");
...
var route = Nitric.Sdk.Nitric.Api("main").Route("/customers", new RouteOptions
{
