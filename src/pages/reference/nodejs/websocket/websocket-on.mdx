...
Websocket connections need to be managed. This can be done using any persistent data store you like. One approach is to use a Nitric [key value store](https://nitric.io/docs/keyvalue).
