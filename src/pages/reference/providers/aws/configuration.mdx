...
# The provider to use and it's published version (see [Releases](https://github.com/nitrictech/nitric/tags))
...
# Configure deployed apis
apis:
  # Use nitric name to select API to configure 
  main:
    # Bind custom domains to the API Gateway
    # Domain must be a managed zone root or subdomain in Route53.
    domains:
      - api.example.com
