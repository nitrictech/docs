export const description = 'How Nitric deploys APIs to Google Cloud'
...
- Files referenced by the `handlers` key in the `nitric.yaml` file are built into container images
