...
You're also able to [create your own Terraform provider](/reference/providers/custom/building-custom-provider) for Nitric, this is the best option when you have existing Terraform Modules and expertise you want to reuse to deploy Nitric app.
