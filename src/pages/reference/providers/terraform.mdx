...
<Note>
  Terraform providers are currently in preview, they're not recommended for production deployments. We recommend using the [Standard Provider](/reference/providers) for production deployments until the Terraform providers are stable.
</Note>
...
You're also able to [create your own Terraform provider](/reference/terraform/custom-providers) for Nitric, this is the best option when you have existing Terraform Modules and expertise you want to reuse to deploy Nitric app.
