...
<Note>
  ...
  another IfC tool, such as Terraform, those providers are [also available](./terraform) or you can [build
  your own](./custom/building-custom-provider).
</Note>
