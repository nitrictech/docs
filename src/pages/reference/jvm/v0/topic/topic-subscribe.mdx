export const description =
  "Reference for Nitric's JVM library - Subscribe a handler to a topic and receive new events for processing."
...
<Properties>
  <Property name="middleware" required type="Middleware<EventContext> or List<Middleware<EventContext>>">
