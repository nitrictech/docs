export const description =
  "Reference for Nitric's JVM library - Set the value of a document"
...
fun main() {
  val profiles = Nitric.collection("profiles", User::class.java).with(CollectionPermission.Write)
...
fun main() {
  val profiles = Nitric.collection("profiles", User::class.java).with(CollectionPermission.Read, CollectionPermission.Write)
