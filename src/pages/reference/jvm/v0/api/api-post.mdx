export const description =
  "Reference for Nitric's v0 JVM library - Register an API route and set a specific HTTP POST handler on that route."
...
public class Application {
  ...
  public static void main(String[] args) {
    ...
    api.post("/customer", List.of(Application::validateRequest, Application::handleRequest));
...
fun main() {
  ...
  api.post("/customer", listOf(validateRequest, handleRequest))
