export const description =
  'Use Pulumi Cloud as a state backend when deploying your Nitric applications'
...
You can get the Nitric CLI by following the instructions [here](/guides/getting-started/installation). Once its set up you can scaffold a new project by running:
...
If you don't have the Pulumi CLI set up take a look at their [installation documentation](https://www.pulumi.com/get-started/install/). You can check if you're logged in with by running:
