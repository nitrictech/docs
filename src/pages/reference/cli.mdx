...
To verify your [installation](/guides/getting-started/v0/installation) run `nitric version`. If a version is printed, the CLI is installed correctly.
...
The command will also create a `nitric.yaml` file. This file contains the configuration for your project. The services key is list of globs for your functions. The services should point to all services you want to run or deploy.
