...
This will run the Nitric server for local testing. This will output local endpoints for your apis and open the [local dashboard](/guides/getting-started/local-dashboard) for testing.
