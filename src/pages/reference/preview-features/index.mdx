...
| ------------------------------------------------------- | ---------------- | ----------------------------------------------------------- |
| [docker providers](/reference/providers/install/docker) | 0.3.0            | [feedback](https://github.com/nitrictech/nitric/issues/605) |

## Released Preview Features

<Note>
  There have been no preview features released post the v1.0.0 release of Nitric.
</Note>
