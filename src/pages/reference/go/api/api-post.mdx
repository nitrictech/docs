export const description =
  "Reference for Nitric's v0 Go library - Register an API route and set a specific HTTP POST handler on that route."
...
func main() {
  ...
  api.Post("/public", func(ctx *handler.HttpContext, next handler.HttpHandler) (*handler.HttpContext, error) {
    // Handle request
    return next(ctx)
