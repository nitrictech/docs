export const description =
  "Reference for Nitric's v0 Go library - Register a handler for HTTP DELETE requests to the route."
...
func main() {
  ...
  api.NewRoute("/hello").Delete(func(ctx *handler.HttpContext, next handler.HttpHandler) (*handler.HttpContext, error) {
...
```go
api.NewRoute("/hello/:name").Delete(func(ctx *handler.HttpContext, next handler.HttpHandler) (*handler.HttpContext, error) {
...
func main() {
  ...
  api.NewRoute("/public").Delete(func(ctx *handler.HttpContext, next handler.HttpHandler) (*handler.HttpContext, error) {
    // Handle request
    return next(ctx)
...
func main() {
  ...
  api.NewRoute("/hello/:name").Delete(handler.ComposeHttpMiddleware(authMiddleware, handleRequest))
