...
```go
api.NewRoute("/hello/:name").Delete(func(ctx *apis.Ctx) {
...
func main() {
  ...
  api.NewRoute("/public").Delete(func(ctx *apis.Ctx) {
    // Handle request
...
func main() {
  ...
  api.NewRoute("/hello/:name").Delete(nitric.Compose(authMiddleware, handleRequest))
