...
func main() {
  ...
  api.Put("/hello", func(ctx *apis.Ctx) {
...
```go
api.Put("/hello/:name", func(ctx *apis.Ctx) {
...
func main() {
  defaultOidcRule := apis.OidcRule(
	...
	secureApi.Put("/public", func(ctx *apis.Ctx) {
		// Handle request
...
func main() {
  ...
  api.Put("/hello/:name", nitric.Compose[apis.Ctx](authMiddleware, handleRequest))
