...
func main() {
  ...
  api.Put("/hello", func(ctx *handler.HttpContext, next handler.HttpHandler) (*handler.HttpContext, error) {
...
```go
api.Put("/hello/:name", func(ctx *handler.HttpContext, next handler.HttpHandler) (*handler.HttpContext, error) {
...
func main() {
	...
	secureApi.Put("/public", func(ctx *handler.HttpContext, next handler.HttpHandler) (*handler.HttpContext, error) {
		// Handle request
		return next(ctx)
...
func main() {
  ...
  api.Put("/hello/:name", handler.ComposeHttpMiddleware(authMiddleware, handleRequest))
