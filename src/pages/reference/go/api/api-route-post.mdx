...
func main() {
  ...
  api.NewRoute("/hello").Post(func(ctx *apis.Ctx) {
...
```go
api.NewRoute("/hello/:name").Post(func(ctx *apis.Ctx) {
...
func main() {
  ...
  api.NewRoute("/public").Post(func(ctx *apis.Ctx) {
    // Handle request
...
func main() {
  ...
  api.NewRoute("/hello/:name").Post(nitric.Compose(authMiddleware, handleRequest))
