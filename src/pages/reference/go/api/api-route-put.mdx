export const description =
  "Reference for Nitric's v0 Go library - Register a handler for HTTP PUT requests to the route."
...
func main() {
  ...
  api.NewRoute("/hello").Put(func(ctx *handler.HttpContext, next handler.HttpHandler) (*handler.HttpContext, error) {
...
```go
api.NewRoute("/hello/:name").Put(func(ctx *handler.HttpContext, next handler.HttpHandler) (*handler.HttpContext, error) {
...
func main() {
  ...
  api.NewRoute("/public").Put(func(ctx *handler.HttpContext, next handler.HttpHandler) (*handler.HttpContext, error) {
    // Handle request
    return next(ctx)
...
func main() {
  ...
  api.NewRoute("/hello/:name").Put(handler.ComposeHttpMiddleware(authMiddleware, handleRequest))
