...
func main() {
  ...
  api.NewRoute("/hello").Put(func(ctx *apis.Ctx) {
...
```go
api.NewRoute("/hello/:name").Put(func(ctx *apis.Ctx) {
...
func main() {
  ...
  api.NewRoute("/public").Put(func(ctx *apis.Ctx) {
    // Handle request
...
func main() {
  ...
  api.NewRoute("/hello/:name").Put(nitric.Compose(authMiddleware, handleRequest))
