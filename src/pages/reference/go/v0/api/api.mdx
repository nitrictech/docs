export const description =
  "Reference for Nitric's Go library - Create APIs with the Nitric Node.js SDK"
...
func main() {
	api, err := resources.NewApi("private", resources.WithMiddleware(authMiddleware))
	if err != nil {
		fmt.Println(err)
		return
	}
...
func main() {
	v1Api, err := resources.NewApi("public", resources.WithPath("/api/v1/"))
	if err != nil {
		fmt.Println(err)
		return
	}
