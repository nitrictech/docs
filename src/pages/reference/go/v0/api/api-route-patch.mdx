...
func main() {
	...
	api.NewRoute("/hello").Patch(func(ctx *faas.HttpContext, next faas.HttpHandler) (*faas.HttpContext, error) {
...
```go
api.NewRoute("/hello/:name").Patch(func(ctx *faas.HttpContext, next faas.HttpHandler) (*faas.HttpContext, error) {
...
func main() {
  ...
  api.NewRoute("/public").Patch(func(ctx *faas.HttpContext, next faas.HttpHandler) (*faas.HttpContext, error) {
    // Handle request
    return next(ctx)
...
func main() {
  ...
  api.NewRoute("/hello/:name").Patch(faas.ComposeHttpMiddleware(authMiddleware, handleRequest))
