...
func main() {
	...
	api.Delete("/hello", func(ctx *faas.HttpContext, next faas.HttpHandler) (*faas.HttpContext, error) {
...
```go
api.Delete("/hello/:name", func(ctx *faas.HttpContext, next faas.HttpHandler) (*faas.HttpContext, error) {
...
func main() {
  ...
  api.Delete("/public", func(ctx *faas.HttpContext, next faas.HttpHandler) (*faas.HttpContext, error) {
    // Handle request
    return next(ctx)
...
func main() {
  ...
  api.Delete("/hello/:name", faas.ComposeHttpMiddleware(authMiddleware, handleRequest))
