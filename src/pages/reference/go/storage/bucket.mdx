export const description =
  "Reference for Nitric's v0 Go library - Create a new bucket for storing and retrieving files."
...
func main() {
  bucket, err := nitric.NewBucket("bucket-name").Allow(nitric.BucketWrite, nitric.BucketRead, nitric.BucketDelete)
  if err != nil {
    return
  }
