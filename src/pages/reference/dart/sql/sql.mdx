export const description =
  "Reference for Nitric's Dart library - Creates a reference to a SQL database."
...
### Create a reference to a database with a migration file
...
### Create a reference to a database with a migration dockerfile
