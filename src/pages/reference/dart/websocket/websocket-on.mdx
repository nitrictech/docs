export const description =
  "Reference for Nitric's Dart library - Register a handler for connections, disconnections, or messages for the websocket."
...
final socket = Nitric.websocket("socket");
final connections = Nitric.store("connections").requires([
