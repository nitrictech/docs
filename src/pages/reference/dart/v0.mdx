export const description =
  "Reference for Nitric's v0 Dart library - Using Nitric with JavaScript and TypeScript"

# Nitric\'s Dart SDK

This SDK reference provides documentation for the services and methods in Nitric\'s Dart library for JavaScript and TypeScript.
