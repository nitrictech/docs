...
In v1.x security definitions, now called rules, are created as standalone objects and then applied to the API or route. This ensures unapplied security definitions are more obvious and less likely to be overlooked.
