...
func main() {
	apiKey, err := resources.NewSecret("api-key").With(resources.SecretPutting, resources.SecretAccessing)
	if err != nil {
		return
	}
...
func main() {
	apiKey, err := resources.NewSecret("api-key").With(resources.SecretPutting)
	if err != nil {
		return
	}
