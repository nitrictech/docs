...
You can also choose to store these values as [environment variables](/resources/env).
...
<Note>
  Version IDs are for illustration only. The specific id/numbering strategy
  depends on the underlying secrets manager of the cloud provider.
</Note>
