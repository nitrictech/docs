...
Application's built with Nitric don't have a strict project structure. Templates for each supported language, which can be a good place to start when learning how to build with Nitric. There are only two types of files required by Nitric projects:
