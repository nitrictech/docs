...
Note: The local runtime emulation feature described in the development section is also a provider which allows you to run your code on your own machine during development.
