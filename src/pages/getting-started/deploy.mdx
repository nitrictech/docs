...
We're hard at work on the future of the open-source Nitric Framework and other services from the team at Nitric. We appreciate your interest and encourage you to follow our latest announcements elsewhere on this site, [GitHub](https://github.com/nitrictech/nitric) and [Discord](https://discord.gg/Webemece5C).
...
- Get started on one of our [guides](/guides/nodejs/serverless-rest-api-example) to build a new project with the Nitric CLI
