export const description = 'Comparison to Winglang'

# Wing vs. Nitric

[Wing](winglang.io) and Nitric share common goals of allowing developers to build modern applications for the cloud without worrying about infrastructure. Where they differ is on approach and fine details.
