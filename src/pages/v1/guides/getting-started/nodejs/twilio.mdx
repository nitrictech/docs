...
Thats it! If you want to deploy the API you can using our [deployment](/guides/getting-started/v0/quickstart#deploying-the-app) docs. If you want to attach a frontend to the application so its a bit more user friendly, you can use any framework you want or follow our [Next.js guide](./api-with-nextjs)
