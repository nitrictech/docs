...
You can get the Nitric CLI by following the instructions [here](/guides/getting-started/v0/installation). Once its set up you can scaffold a new project by running:
