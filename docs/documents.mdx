...
Subcollection queries can be created under a collection document's subcollection `collection.document.collection.query`

We are performing a collection document subcollection query where we
