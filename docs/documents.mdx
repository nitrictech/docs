...
const query = docs.collection('Customers').collection('Orders').query();
...
<br />
The steam() method is not yet implemented. Please use the QueryResults foreach()
method instead. To scroll over all collection results use the fetchAll() method.
