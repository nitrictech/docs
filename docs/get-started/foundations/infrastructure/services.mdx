...
Ok, we've learned about how [Nitric helps with infrastructure](/docs/get-started/foundations/infrastructure), now let's dive _where_ you run your code: Services.
...
See the [Project Configuration](/docs/get-started/foundations/projects/configuration) page for more information on defining services in your project.
...
See the [Custom Containers](/reference/custom-containers) and [Project Configuration](/docs/get-started/foundations/projects/configuration) pages for more information about how to customize the way Nitric builds your services.
