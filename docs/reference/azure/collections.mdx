...
During deployment Nitric's CLI builds your Collections will be built as follows:

- The topic defintion and resource group are deployed as a MongoDB Collection.
