...
Currently region support is limited to 'us-east-2', this will expand as the 'Container Apps' becomes available in other regions.
...
We've summarized instructions here, for more options reference the [Microsoft docs](https://docs.microsoft.com/en-us/cli/azure/install-azure-cli).
