...
A new secret version is always created when calling `put()`, the versions will automatically be provided a unique id. This behaviour is dependent on the underlying secrets manager.
