...
```yaml file:root/backends/guestbook-app/nitric.yaml
name: guestbook-app
services:
  - match: services/*.ts
    runtime: turbo
...
```docker file:root/backends/guestbook-app/turbo.dockerfile"  }}
