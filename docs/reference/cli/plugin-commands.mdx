...
<table>
    ...
    <tr>
      ...
      <td>
        Nitric descriptor file location
      </td>
    </tr>
</table>
...
<table>
    ...
    <tr>
      ...
      <td>
        file containing the stack definition of the stack to be torn down
      </td>
    </tr>
</table>
...
<table>
    ...
    <tr>
      ...
      <td>tear down a stack from Google Cloud Platform (GCP) previously deployed with &#x60;$nitric deploy:gcp&#x60;</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
      ...
      <td>
        Digital Ocean Container Registry to deploy containers to
      </td>
    </tr>
    <tr>
      <td>--region</td>
      ...
      <td>
        Digital Ocean Region to deploy to
      </td>
    </tr>
    <tr>
      <td>--file</td>
