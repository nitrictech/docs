...
<table>
  ...
  <tr>
    <td>--file</td>
    <td>No</td>
    <td>the stack definition file (default: .&#x2F;nitric.yaml)</td>
  </tr>
  <tr>
    <td>--provider</td>
    <td>No</td>
    <td>the targeted provider for this build</td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    <td>--ci</td>
    <td>No</td>
    <td>check environment for config and prerequisite software</td>
  </tr>
  <tr>
    <td>--help</td>
    <td>No</td>
...
<table>
  ...
  <tr>
    <td>--ci</td>
    <td>No</td>
    <td>builds and runs a project locally for testing</td>
  </tr>
  <tr>
    <td>--help</td>
    <td>No</td>
...
<table>
  ...
  <tr>
    <td>--ci</td>
    <td>No</td>
    <td>Creates a new Nitric stack</td>
  </tr>
  <tr>
    <td>--help</td>
    <td>No</td>
