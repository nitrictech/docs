A unit test is testing small piece of logically isolated code, usually a function, subprogram, method or property. Unit tests provide confidence in the code thats been written. This confidence gives you the ability to create new features, without fear of breaking older code.
