export const description =
  "Reference for Nitric's v0 JVM library - Register an API route and set a specific HTTP PUT handler on that route."
...
fun main() {
  ...
  api.put("/customer", listOf(validateRequest, handleRequest))
