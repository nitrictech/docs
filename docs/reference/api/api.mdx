...
| -------------- | -------- | --------------------------------------------------------- | -------------------------------------- |
| **path**       | No       | Base path for all routes in the API.                      | `string`                               |
| **middleware** | No       | Middleware to apply to all routes and methods of the API. | `HttpMiddleware` or `HttpMiddleware[]` |
