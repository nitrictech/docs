...
During deployment nitric may deploy an App Engine application to your project if one does not already exist, this ensures the Appengine region of your GCP project is set.
