export const description =
  "Reference for Nitric's v0 Node.js library - Get a query-only sub-collection reference, this can be used to query commonly named collections across documents."
