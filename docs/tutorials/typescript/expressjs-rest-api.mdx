...
This tutorial assumes you already have the Nitric CLI installed, if not you can follow the [install guide](/docs/installation).
...
> Learn more: [Key/Value Store Documenation](/docs/key-value)
