...
2. Create functions to handle API operations
3. Create a Key/Value collection to store data
4. Setup an API gateway and bind it to the functions
...
If you’d like to deploy the results to a cloud environment *(optional)*, you’ll also need to set up your credentials and any other details for [AWS](/docs/providers/AWS), [GCP](/docs/providers/GCP) or [Azure](/docs/providers/azure).
