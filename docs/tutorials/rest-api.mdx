...
If you’d like to deploy the results to a cloud environment *(optional)*, you’ll also need to set up your credentials and any other details for [AWS](/docs/provider-aws), [GCP](/docs/provider-gcp), [DigitalOcean](../provider-digitalocean) or [Azure](/docs/provider-azure).
...
> Learn more: [Key/Value Documentation](/docs/key-value)
