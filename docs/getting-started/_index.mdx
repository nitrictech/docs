...
>
  <Link href="/docs/getting-started/multi-cloud">
    <img src="/img/logos/aws.png" noMargin priority height={100} />
  </Link>
  <Link href="/docs/getting-started/multi-cloud">
    <img src="/img/logos/gcp.svg" noMargin priority height={150} />
  </Link>
  <Link href="/docs/getting-started/multi-cloud">
    <img src="/img/logos/azure.png" noMargin priority height={150} />
  </Link>
  <Link href="/docs/getting-started/multi-cloud">
    <img src="/img/logos/digital-ocean.png" noMargin priority height={150} />
  </Link>
</Box>
