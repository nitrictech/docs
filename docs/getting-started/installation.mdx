...
At this point you have everything setup and ready to build applications, then run and test them locally. You can read more about the [Nitric CLI](/docs/reference/cli), try out a [Tutorial](/docs/getting-started/multi-cloud) or if you're ready to deploy an application to a cloud environment, you can jump to the [deployment stage](/docs/getting-started/multi-cloud/deploy) of our tutorial or read more about our supported cloud providers [AWS](/docs/intro/cloud-providers/aws), [Google Cloud](/docs/intro/cloud-providers/gcp), [DigitalOcean](/docs/intro/cloud-providers/digital-ocean) or [Microsoft Azure](/docs/intro/cloud-providers/azure).
