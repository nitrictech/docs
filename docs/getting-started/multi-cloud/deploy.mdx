...
> 🚧 **Partial Support**: Nitric currently supports DigitalOcean for [Services](/docs/intro/concepts/services) and [Entrypoints](/docs/reference/project/entrypoints) only.
