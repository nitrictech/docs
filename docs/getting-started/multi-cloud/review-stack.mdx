...
- `api.yaml` defines the [API](/docs/intro/concepts/nitric-apis).
- Three [Functions](/docs/intro/concepts/functions) are generated:
  - `functions/create/**/CreateHandler.java` is the function that creates new documents.
  - `functions/list/**/ListHandler.java` is the function that lists multiple documents.
  - `functions/read/**/ReadHandler.java` is the function that can read a single document.
