...
| Properties                                                                                                                        |
| --------------------------------------------------------------------------------------------------------------------------------- |
| **id** optional `string` <br/> unique id to apply to the event. If an id isn't provided, a version 4 UUID will be auto-generated. |
| **payload** required `Map<string, any>` <br/> payload to send with the event.                                                     |
