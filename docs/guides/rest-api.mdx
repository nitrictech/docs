...
Need to validate user permissions for your API? Try adding Authentication to your API by using [Nitric HTTP Middleware](/docs/guides/rest-api-jwt-middleware).
