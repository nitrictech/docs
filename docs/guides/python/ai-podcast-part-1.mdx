---
title_seo: Building an autonomous AI podcast with Nitric - Part 1
...
This will generate a nitric stack file called `aws` that defines how we would like to deploy a stack to AWS.
