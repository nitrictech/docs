...
The first step is to ensure the application is deployed before running our tests. The [quickstart](/getting-started/quickstart#deploying-the-app) provides details on how to do this for the first time if you're unfamiliar.
