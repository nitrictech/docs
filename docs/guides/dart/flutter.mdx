...
```dart {{ label: "lib/providers/favorites.dart" }}
import 'dart:convert';
...
final encodedfavorites = jsonEncode(favorite.toJson(favorite(pair.asLowerCase)));
...
```dart {{ label: "lib/pages/favorites.dart" }}
import 'package:flutter/material.dart';
import 'package:word_generator/providers/favorites.dart';
import 'package:provider/provider.dart';
