...
![new table steps diagram](img/supabase_createnewtable.png)
...
![create profiles table steps diagram](img/supabase_createprofilestable.png)
...
![SendGrid create new sender dialog screenshot](img/sendgrid_newsenderdetails.png)
...
![create API key dialog screenshot](img/sendgrid_createapikey.png)
...
![example project structure](img/project_structure.png)
...
![create function hook screenshot](img/supabase_createfunctionhook.png)
...
![create function hook screenshot - step 1](img/supabase_createfunctionhook_step1.png)


For _Type of hook_ select _HTTP Request_:

![create function hook screenshot - step 2](img/supabase_createfunctionhook_step2.png)
...
![create function hook screenshot - step 3](img/supabase_createfunctionhook_step3.png)
...
![Supabase editor screenshot](img/supabase_insertrow.png)
