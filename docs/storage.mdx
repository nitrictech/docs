...
storageClient.write("my-bucket", "path/to/item", content)
```
...
const content = storageClient.read("my-bucket", "path/to/item");
```
...
// Read a byte array from a bucket
const content = storageClient.delete("my-bucket", "path/to/item");
```
