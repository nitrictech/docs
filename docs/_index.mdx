...
>
  <Link href="/docs/getting-started">
    <img src="/img/logos/aws.png" noMargin priority height={70} />
  </Link>
  <Link href="/docs/getting-started">
    <img src="/img/logos/gcp.svg" noMargin priority height={100} />
  </Link>
  <Link href="/docs/getting-started">
    <img src="/img/logos/azure.png" noMargin priority height={100} />
  </Link>
  <Link href="/docs/getting-started">
    <img src="/img/logos/digital-ocean.png" noMargin priority height={100} />
  </Link>
</Box>
...
> Learn about the cloud service [APIs offered by Nitric](./nitric-apis) and how they run in each cloud.
