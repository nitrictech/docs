...
Nitric's cloud deployments are built on a pluggable interface known as [providers](/providers). All of Nitric's standard providers [AWS](/providers/pulumi/aws), [GCP](/providers/pulumi/gcp) and [Azure](/reference/providers/azure) are powered by [Pulumi](https://pulumi.com).
...
<Note>
  ...
  available](/providers/terraform) or you can [build your
  own](/providers/custom/create).
</Note>
...
You can get the Nitric CLI by following the instructions [here](/get-started/installation). Once its set up you can scaffold a new project by running:
