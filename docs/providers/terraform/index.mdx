...
You're also able to [create your own Terraform provider](/providers/custom/create) for Nitric, this is the best option when you have existing Terraform Modules and expertise you want to reuse to deploy Nitric applications.

<Note>
  If you're new to Terraform and/or Nitric, we recommend starting with a
  [standard Nitric provider](/providers/pulumi). The Terraform provider is more
  advanced and requires a foundational understanding of Terraform.
</Note>
