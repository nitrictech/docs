...
Named `nitric.yaml` by default, this file defines of your application and its resources. Since resources such as topics, queues, buckets, etc. are as much a part of modern applications as the code is, this file defines all of these resources and their interactions. The benefit of this model is that the "intention" behind these interactions is clearly described, allowing for consistent implementations between providers.
