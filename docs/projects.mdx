...
A Function a deployable unit of code to handle a single purpose. Functions are analogous to an AWS Lambda functions or GCP Cloud Functions and provide the code building blocks for creating larger _Services_ and _Applications_.
