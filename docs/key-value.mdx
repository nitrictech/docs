...
> ⚠️ **Note** a new Document Service is being development which provides a superset of Key Value service functionality.
> When the Document Service is released the Key Value service will be deprecated.
