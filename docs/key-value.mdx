...
> ⚠️ WARNING: The Key Value store will be superseded in the near future by the Document Service. The Key Value service will remain availabe but Deprecated until the Nitric Membrane 1.0 release
