...
- supports multi development languages
- project templates
...
Making the choice for Custom Build over Nitric will prematurely reduces Optionality for the business, this may include:

- only supporting one Cloud vendor, limiting future business sales options and reduces cloud pricing control
- supporting only one language, which can limit future business sales options, limits available dev talent and best language choice for the domain
