A Stack is a collection of resources defined using a stack file, named `nitric.yaml` by default. Stacks typically define some code functions and cloud resources.
