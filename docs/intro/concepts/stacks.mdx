A [Stack](/docs/reference/project/stack) is a collection of resources defined using a stack file, named `nitric.yaml` by default. Stacks typically define some code functions and cloud resources.
...
Some stacks are infrastructure only, deploying shared resources and act as a dependency to other stacks. A REST API would typically be defined in a Stack.
