...
When building new [Compute](./compute) Services or Functions based on official Nitric Templates, the Membrane and typically one of the official SDKs will be pre-installed and configured. There is no additional configuration or authentication required to interact with the Membrane, or the APIs it offers.

If you'd like to explore other installation options or require more advanced configuration, instructions are provided on the [Membrane GitHub Project](https://github.com/nitrictech/nitric).
