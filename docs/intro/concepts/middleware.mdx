...
* can chooses whether to pass the event to the next middleware in the pipeline
...
<img
  src="../../../assets/img/middleware-1.svg"
...
<img
  src="../../../assets/img/middleware-2.svg"
  alt="Middleware Sequence"
/>

Another important use of middleware is processing requests and augmenting them additional information which next middlewares can use. Examples of this include:
