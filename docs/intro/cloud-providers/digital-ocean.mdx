...
Below is a list of the current support status for each Nitric Service, when deployed to DigitalOcean.

| **Service**        | **Status** | **Underlying Service** |
| ------------------ | ---------- | ---------------------- |
| Compute            | Preview    | App Platform           |
| Events             | Backlog    |                        |
| Queues             | Backlog    |                        |
| Storage            | Backlog    |                        |
| Key/Value          | Backlog    |                        |
| Schedules          | Backlog    |                        |
| API Gateways       | Backlog    |                        |
| Entrypoints        | Preview    | App Platform           |
| Sites              | Backlog    |                        |
| Container Registry | Preview    | Container Registry     |
