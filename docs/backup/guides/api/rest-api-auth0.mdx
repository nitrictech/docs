...
<CodeSnippet snippet="nitrictech/nitric-examples/typescript/rest-api-auth/common/auth.ts" />
...
<CodeSnippet snippet="nitrictech/nitric-examples/typescript/rest-api-auth/functions/create.ts" />

#### Read Orders

Next, add the following code to your `functions/read.ts` file, again replacing the **domain** and **audience** options with your own:

<CodeSnippet snippet="nitrictech/nitric-examples/typescript/rest-api-auth/functions/read.ts" />
...
<CodeSnippet snippet="nitrictech/nitric-examples/typescript/rest-api-auth/functions/list.ts" />
