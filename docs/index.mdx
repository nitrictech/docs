...
You can read about Nitric's [Local Development](/get-started/local-development) features in the Foundations section.
...
You can read more about [Nitric Providers](/get-started/foundations/providers) in the Foundations section.
...
We recommend reading more about [Nitric Deployments](/get-started/foundations/deployments) in the Foundations section.
